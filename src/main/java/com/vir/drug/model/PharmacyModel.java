...
public class PharmacyModel  {
	...
	private List<DrugSearchModel> drugSearchModel;
	...
	/**
	 * @param pharmacyMasterId
	 *            the pharmacyMasterId to set
	 */
	 ...
	 */
	public List<DrugSearchModel> getDrugSearchDTO() {
		return drugSearchModel;
	}

	/**
	 * @param drugSearchModel
	 *            the drugSearchDTO to set
	 */
	public void setDrugSearchDTO(List<DrugSearchModel> drugSearchModel) {
		this.drugSearchModel = drugSearchModel;
	}
